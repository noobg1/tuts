...
describe('#negative cases :toReduce function takes (String array, helper function for reduce operation, initial value object) as arguments and ', function () {
  ...
  it('should return error message for non array first argument', function () {
    var inputWordArray = ['123', 'blah', , 'qwerty', , '', {}];
    var initialObject = {};
    expect(testFunction(reduceHelper, reduceHelper, initialObject)).to.eqls('Expecting array as first argument given: function');
  });

  it('should return error message for non array first argument', function () {
    var inputWordArray = ['123', 'blah', , 'qwerty', , '', {}];
    var initialObject = {};
    expect(testFunction({}, reduceHelper, initialObject)).to.eqls('Expecting array as first argument given: object');
  });
});